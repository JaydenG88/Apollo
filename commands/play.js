...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand((subcommand)=>
            subcommand
            .setName("song")
            .setDescription("Plays singular song from yt url")
    ...
    .addSubcommand((subcommand) =>
        subcommand
            .setName("playlist")
            .setDescription("Plays playlist from yt url")
            .addStringOption((option) => option.setName("url")
    ...
    .addSubcommand((subcommand) =>
        subcommand
            .setName("search")
            .setDescription("Searches for songs from keywords")
     ...
     execute: async ({client, interaction}) => {
        ...
        if (!queue.connection) await queue.connect(interaction.member.voice.connect);
